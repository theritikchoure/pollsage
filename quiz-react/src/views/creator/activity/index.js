                  ...
                  {recentActivity.today.length === 0 && (
                    <li className="flex px-4">
                      <div className="flex-grow flex items-center text-sm text-gray-600 dark:text-gray-100 py-2">
                        <div className="self-center">No recent activity</div>
                      </div>
                    </li>
                  )}
                  {/* <li className="flex px-4">
                ...
                <ul className="my-1">
                  {recentActivity.older.length > 0 &&
                    recentActivity.older.map((activity) => (
                      <li className="flex px-4 h-16 items-center hover:bg-slate-900 border-b">
                        ...
                        {activity.type === "Poll" && (
                          <div className="w-9 h-9 rounded-full flex-shrink-0 bg-green-500 my-2 mr-3">
                            <svg
                              className="w-9 h-9 fill-current text-indigo-50 ml-2 mt-2.5"
                              viewBox="0 0 36 36"
                            >
