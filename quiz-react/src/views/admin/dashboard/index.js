    ...
    <>
      ...
      <div className="bg-slate-800 p-6 mx-4">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4">
          ...
          className={`w-full text-center border ${selectedImportOption === 'User' ? 'border-indigo-500' : 'border-gray-600'} py-1 hover:border-indigo-500 cursor-pointer`}>
            User
          </div>
          <div onClick={() => handleOptionClick('Creator')} 
          className={`w-full text-center border ${selectedImportOption === 'Creator' ? 'border-indigo-500' : 'border-gray-600'} py-1 hover:border-indigo-500 cursor-pointer`}>
            Creator
          </div>
          <div onClick={() => handleOptionClick('Poll')} 
          className={`w-full text-center border ${selectedImportOption === 'Poll' ? 'border-indigo-500' : 'border-gray-600'} py-1 hover:border-indigo-500 cursor-pointer`}>
            Poll
          </div>
          <div onClick={() => handleOptionClick('Something')} 
          className={`w-full text-center border ${selectedImportOption === 'Something' ? 'border-indigo-500' : 'border-gray-600'} py-1 hover:border-indigo-500 cursor-pointer`}>
            Something
          </div>
        </div>
        {selectedImportOption && <div className="bg-slate-900 p-7 mt-4">
