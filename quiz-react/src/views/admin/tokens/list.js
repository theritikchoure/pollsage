...
const AccessTokenList = () => {
  ...
  return (
    <>
      <PageDetails title="Token list - PollSage" description="Create Poll" />
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="grid auto-cols-max justify-end grid-flow-col gap-3">
            ...
            {dateFilter && (
              <div class="bg-slate-800 border border-slate-600 rounded absolute w-44 mt-2 text-md">
                <div class="text-md py-2">
                  ...
                  <button class="flex pl-4 items-center mb-1 text-white w-full h-8 hover:bg-slate-900">
                    <svg
                      class="mr-2 hidden"
                      fill="currentColor"
                      width="12"
          ...
          >
            ...
            <span class="ml-1">Create Token</span>
          </Link>
        </div>
      </div>
