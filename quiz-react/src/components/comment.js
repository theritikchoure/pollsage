...
const Comment = ({ pollId }) => {
  ...
  const loadData = async () => {
    try {
      let res = await getComments(pollId);
  ...
  return (
    <section className="max-w-md mx-auto mt-5">
      <div className="bg-gray-800 custom-box border border-gray-600 sm:border-x sm:rounded-md overflow-hidden">
        ...
        {comments && comments.length < 1 && <div className="border-t border-gray-300 dark:border-gray-700 custom-border">
              ...
              <form className="space-y-3" onSubmit={submitComment}>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => onChangeFormData("display_name", e.target.value)}
                  />
                  {errors.display_name && (
                    <span className="text-red-500 text-xs">{errors.display_name}</span>
                  )}
                </div>
                <div>
              ...
              <div className="flex-grow">
                <div className="text-sm">
                  <span className="flex items-center space-x-2">
                    <span className="text-gray-200">{comment.display_name}</span>
                ...
                <div>
                  ...
                  <div className="mt-2 text-sm space-x-2">
                    ...
                    <span className="text-gray-500 custom-text font-medium">·</span>
                    <button
                      type="button"
